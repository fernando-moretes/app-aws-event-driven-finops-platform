...
const hasRepoLink = links.some((link) => {
  const url = new URL(link, "https://finops.moretes.com");
  return url.protocol === "https:" && url.hostname === "github.com" && url.pathname === "/fernandofatech/aws-event-driven-finops-platform";
});
...
const required = [
  ...
  [html.includes('rel="canonical" href="https://finops.moretes.com/"'), "index.html must include canonical domain"],
  ...
  [robots.includes("Sitemap: https://finops.moretes.com/sitemap.xml"), "robots.txt must point to sitemap"],
  [sitemap.includes("https://finops.moretes.com/"), "sitemap.xml must include canonical domain"],
